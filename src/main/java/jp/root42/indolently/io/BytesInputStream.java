...
public class BytesInputStream
    ...
    public static boolean isAvailable() {
        return ObjFactory.isPresent("org.apache.commons.io.output.UnsynchronizedByteArrayInputStream");
    }

    private final UnsynchronizedByteArrayInputStream bais;

    public BytesInputStream(final byte[] bin) {
        super(new byte[0]);
        this.bais = new UnsynchronizedByteArrayInputStream(bin);
    }
    ...
    @Override
    public void close() throws IOException { this.bais.close(); }
}
