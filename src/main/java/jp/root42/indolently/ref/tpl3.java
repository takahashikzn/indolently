...
public interface tpl3<SELF extends tpl3<SELF, T1, T2, T3>, T1, T2, T3> {
    ...
    <S1, S2, S3> tpl3<?, S1, S2, S3> map(Function3<T1, T2, T3, ? extends tpl3<?, ? extends S1, ? extends S2, ? extends S3>> f);

    <S1, S2, S3> tpl3<?, S1, S2, S3> map(Function<T1, ? extends S1> f1, Function<T2, ? extends S2> f2, Function<T3, ? extends S3> f3);
