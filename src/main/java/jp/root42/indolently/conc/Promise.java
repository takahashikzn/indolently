...
public interface Promise<T> {
    ...
    @SafeVarargs
    static <T> Promise<List<T>> all(final Promise<? extends T>... promises) { return all(list(promises)); }
    ...
    @SafeVarargs
    static <T> Promise<T> any(final Promise<? extends T>... promises) { return any(list(promises)); }
